...
public class EventRecord extends UpdatableRecordImpl<EventRecord> implements Record10<Integer, Integer, String, String, String, Date, Date, Date, Date, String> {

    private static final long serialVersionUID = -1140290659;
     ...
     */
    @Override
    public Row10<Integer, Integer, String, String, String, Date, Date, Date, Date, String> fieldsRow() {
     ...
     */
    @Override
    public Row10<Integer, Integer, String, String, String, Date, Date, Date, Date, String> valuesRow() {
     ...
     */
    @Override
    public EventRecord values(Integer value1, Integer value2, String value3, String value4, String value5, Date value6, Date value7, Date value8, Date value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EventRecord(Integer id, Integer ownerId, String title, String thumbnail, String content, Date salesStart, Date salesEnd, Date startDate, Date endDate, String place) {
        super(Event.EVENT);
